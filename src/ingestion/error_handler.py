...
class ErrorHandler:
    ...
    def log_error(self, event_id: str, error_type: str, error_message: str,
                  raw_data: Dict[str, Any], batch_id: str) -> None:
            ...
            with self.db.get_connection() as conn:
                with conn.cursor() as cur:
                    cur.execute("""
                        ...
                        (batch_id, event_id, error_type, error_message, raw_data, occurred_at)
    ...
    def check_threshold(self) -> bool:
        ...
        if self.error_count >= self.max_errors:
            logger.critical(f"Error threshold exceeded: {self.error_count}/{self.max_errors}")
            return True
        return False
